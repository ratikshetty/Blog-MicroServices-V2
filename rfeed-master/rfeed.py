...
class Comment(Serializable):
        """ A Comment object specifies one or more categories that the channel or item belongs to.
    
        """
        def __init__(self, comment, domain = None):
                """ Keyword arguments:
                comment --     this is the article comment
                domain -- Optional. 
                """

                Serializable.__init__(self)

                if comment is None: raise ElementRequiredError("comment")
        ...
        def publish(self, handler):
                ...
                self._write_element("comment", self.comment, { "domain": self.domain } if self.domain is not None else {})
...
class Item(Host):
	...
	creator = None, categories = None, comments = None, enclosure = None,
		guid = None, pubDate = None, source = None, comment = None, date = None, extensions = None):
		""" Keyword arguments:
		...
		if isinstance(self.categories, Category):
			...
			self.categories = [Category(self.categories)]
                ...
                if isinstance(self.comment, Comment):
                        self.comment = [self.comment]
                elif isinstance(self.comment, basestring):
...
class Article(Host):
        ...
        More information at http://cyber.law.harvard.edu/rss/rss.html#hrelementsOfLtitemgt
        """
        def __init__(self, content = None, title = None, author = None, date = None, link = None, categories = None, extensions = None):
                """ Keyword arguments:
                title -- Optional. The title of the item.
                link  -- Optional. The URL of the item.
                description -- Optional. The item synopsis.
        ...
        def publish(self, handler):
                ...
                self.handler.startElement("article", {})
                ...
                self.handler.endElement("article")
...
class Feed(Host):
	def __init__(self, title, link, description, language = None, copyright = None, managingEditor = None, webMaster = None, pubDate = None,
		...
		textInput = None, skipHours = None, skipDays = None, items = None, extensions = None, articles = None):
		""" Keyword arguments:
